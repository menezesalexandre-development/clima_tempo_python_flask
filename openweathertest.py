...
def clima_tempo_city(nome_cidade):
    try:
...
def clima_tempo_coordinates(latitude, longitude):
    try:
        chave_api_pyowm = 'e4301b8a9bd9d49f970948fbd02f5b5f'

        url = f"https://api.openweathermap.org/data/2.5/weather?lat={latitude}&lon={longitude}&appid={chave_api_pyowm}"
